...
class CassiLayer(tf.keras.layers.Layer):
    ...
    def build(self, input_shape):
        #
        #path = '/content/gdrive/My Drive/TemporalSimulation_200x200x8/Tools/Opt_50'
        #mask = hdf5storage.loadmat(path)['Iter']     
        #mask = (mask[0:self.M,0:self.N])        
